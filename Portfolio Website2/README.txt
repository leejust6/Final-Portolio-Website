**NEW CHANGES TO PORTFOLIO**

+ Make body text size larger
+ Changed font from helvetica to helvetica bold (more align with AKIRA font without losing readability,etc.)
+ Added mail link to email address
+ Added download button for resume 
+ Made navi font bigger (home and navibar)
+ Added Javascript business popup card to contact page
+ Added more responsive functions
